...
from app.schemas.event import EventPageResponse
...
async def list_events(
    ...
    # Radar is forward-looking: never page through events that already started.
    stmt = select(ScrapedEvent).where(ScrapedEvent.start_date >= datetime.now(timezone.utc))
